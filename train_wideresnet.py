...
#from resnet import *
from pgd_loss import *
import numpy as np
import time

os.environ["CUDA_VISIBLE_DEVICES"]="0"

parser = argparse.ArgumentParser(description='PyTorch Angular AT Defense')
parser.add_argument('--batch-size', type=int, default=128, metavar='N',
                    help='input batch size for training (default: 128)')
parser.add_argument('--test-batch-size', type=int, default=128, metavar='N',
                    help='input batch size for testing (default: 128)')
parser.add_argument('--epochs', type=int, default=98, metavar='N',
...
parser.add_argument('--save-freq', '-s', default=1, type=int, metavar='N',
                    help='save frequency')
parser.add_argument('--loss', default='pgd_he', type=str, help= 'loss_train')
parser.add_argument('--distance', default='l_inf', type=str, help='distance')
parser.add_argument('--m', default=0.0, type=float, help='angular margin')
...
def main():
    ...
    for epoch in range(1, args.epochs + 1):
        ...
        print('================================================================')
           ...
           #torch.save(model.state_dict(), '../chyper/at_3rel_0.55labelcos_0.03weilastlast_s15_wideresnet-34-epoch.pt')
